"""
An example of running stacked contractive autoencoders.
Yifeng Li
CMMT, UBC, Vancouver
Sep. 23, 2014
...
# train
classifier,training_time=ScA.train_model(train_set_x_org=train_set_x_org, train_set_y_org=train_set_y_org, 
                ...
                n_hidden=[64,64,32], contraction_levels=[0.01,0.01,0.01],
                pretraining_epochs=5, training_epochs=1000,
                batch_size=200, rng=rng)
                        
# test
test_set_y_pred=ScA.test_model(classifier, test_set_x_org, batch_size=200)
